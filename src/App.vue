<template>
  ...
  <div class="px-3 py-10 md:px-10">
      <div class="w-full sm:w-1/2 lg:w-1/3 mx-auto">
          ...
          <!-- Todo form -->
          <form class="flex items-center px-4 bg-gray-900 h-15 rounded-sm border-l-2 border-blue-400 mb-3">
              <input
              ...
              <button
                  class="text-blue-400 text-xs font-semibold focus:outline-none"
                  type="submit"
              >
                  ADICIONAR
              </button>
                  ...
                  <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
                      <div class="flex items-center justify-center mr-2">
                          <button class="text-gray-400">
                              <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                          </button>
                      </div>
